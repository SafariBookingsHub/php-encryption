...
class RuntimeTests extends Crypto {
	...
	public static function runtimeTest()
	{
		...
		try
		{
			...
			Core::ensureTrue(Core::ourStrlen(Key::createNewRandomKey()
					->getRawBytes()) === Core::KEY_BYTE_SIZE);

			Core::ensureTrue(Core::ENCRYPTION_INFO_STRING
	...
	private static function AESTestVector()
	{
		...
		$computed_plaintext = Crypto::plainDecrypt($ciphertext, $key, $iv,
			Core::CIPHER_METHOD);
